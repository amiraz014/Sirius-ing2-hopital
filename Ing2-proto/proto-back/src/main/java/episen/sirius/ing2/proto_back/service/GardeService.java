...
public class GardeService {
    ...
    public void planifierGardes(LocalDate debut, LocalDate fin) {
        ...
        List<String> nomProfessionGardeSoir = Arrays.asList("Médecin généraliste","Radiologue","Urgentiste", "Pharmacien", "Infirmier", "Sage-femme", "Ambulancier", "Chef de service");
